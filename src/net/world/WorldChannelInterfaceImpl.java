...
public class WorldChannelInterfaceImpl extends UnicastRemoteObject implements WorldChannelInterface {
    ...
    @Override
    public boolean createHideout(int map, int guildid) throws RemoteException {
        return WorldRegistryImpl.getInstance().createHideout(map, guildid);
    }

    @Override
    public boolean extendHideoutTime(int guildid) throws RemoteException {
        return WorldRegistryImpl.getInstance().extendHideoutTime(guildid);
    }

    @Override
    public void removeHideout(int guildid) throws RemoteException {
        WorldRegistryImpl.getInstance().removeHideout(guildid);
    }
