...
public class BuddylistModifyHandler extends AbstractMaplePacketHandler {
    ...
    public static class CharacterIdNameBuddyCapacity extends CharacterNameAndId {
    ...
    public void nextPendingRequest(MapleClient c) {
    ...
    public CharacterIdNameBuddyCapacity getCharacterIdAndNameFromDatabase(String name) throws SQLException {
    ...
    public void notifyRemoteChannel(MapleClient c, int remoteChannel, int otherCid, BuddyOperation operation)
