...
public class MapleTrade {
    ...
    public void complete2() {
        ...
        for (IItem item : exchangeItems) {
            MapleInventoryManipulator.addFromDrop(chr.getClient(), item, false, true);
        }
        if (exchangeMeso > 0) {
...
//	}
    ...
    public static void completeTrade(MapleCharacter c) {
        ...
        c.saveToDB(true, true);
        partner.getChr().saveToDB(true, true);
    }
    ...
    public static void cancelTrade(MapleCharacter c) {
        ...
        if (c.getTrade().getPartner() != null) {
            ...
            c.getTrade().getPartner().getChr().saveToDB(true, true);
        }
        c.setTrade(null);
        c.saveToDB(true, true);
    }
