function start() {
	cm.sendSimple("Hey there! I am Eak, the Event assistant. \n I help the GM's with their big events! \n\
...
In this map there are special monsters that give #e1,000,000,000#n EXP! \n\n So, do you have an #eEvent Trophy#n?\n\r\n\
    ...
    if (s == 0){
	    ...
	    cm.loseItem(4000038, 1);
            ...
            cm.startTraining(300);
             cm.sendOk("Alright, enjoy your training");
             cm.dispose();
        }else{
            cm.sendOk("I'm sorry but you do not have an #eEvent Trophy#n.");
            cm.dispose();
        }
