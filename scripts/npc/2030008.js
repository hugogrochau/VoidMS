    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            if (cm.getPlayer().getLevel() >= minLevel) {
                if (cm.getQuestStatus(100200) != client.MapleQuestStatus.Status.COMPLETED
                    && cm.getQuestStatus(100200) != client.MapleQuestStatus.Status.STARTED) {
                ...
                else if (cm.getQuestStatus(100201) == client.MapleQuestStatus.Status.STARTED) {
                ...
                if (cm.getQuestStatus(100201) == client.MapleQuestStatus.Status.COMPLETED) {
