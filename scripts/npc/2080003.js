...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("*looking at his paper* Emerald: check, Iron: check, now what else did I have too bring..\r\n\r\n*looks up* Oh! Hello! Who are you? #L0#I hate hairy midgets.#l \r\n#L1#I'm a friend of Muhamad#l");
    } else if (status == 1) {
        if (selection == 0) {
