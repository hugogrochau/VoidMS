...
status--;
if (status == 0) {
cm.sendSimple("First choice doesn't finish your pirate skills so if your a pirate us 2nd choice.\r\n#L0##r1st Choice!(Some SKills Not done)#l#k\r\n#L1##rSecond Choice!(I max all skills)#l#k");
} else if (status == 1) {
if (selection == 0) {
...
cm.teachSkill(5001001,1,1); //Start of Pirate Job Skills
cm.teachSkill(5001002,1,1);
cm.teachSkill(5001003,1,1);
cm.teachSkill(5001005,1,1);
