    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            cm.sendSimple ("#ePick a Category#n #b" +
                ...
                "\r\n#L98#Hats (13040)" +
                "\r\n#L99#Weapons (13041)" +
                "\r\n#L65#Cash Earrings (10064)" +
                "\r\n#L62#Rings" +
                "\r\n#L49#Megaphones" +
                "\r\n#L64#Emotion" +
                "\r\n#L66#Eye Accessories (10065)" +
                "\r\n#L67#All Accessories (10066)" +
                "\r\n#L68#Effects" +
                "\r\n#L69#Throwing Stars (10068)" +
                "\r\n#L70#Messengers");
        } else if (selection == 0) {
            cm.openShop(10000);
            cm.dispose();
            ...
            cm.sendSimple ("How much NX Cash would you like to buy? \n\r\n #L89#10,000 NX for 500,000 Mesos\n\r\n#L90#25,000 NX for 1,250,000 Mesos\n\r\n#L91#60,000 NX for 3,000,000 Mesos");
            ...
            if (cm.getPlayer().getMeso() < 1250000) {
                cm.sendOk ("Please check to see if you have enough #rMesos#k");
                cm.dispose();
            } else {
                cm.gainMeso (-1250000);
