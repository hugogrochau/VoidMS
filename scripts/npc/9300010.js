...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (!cm.isEtcFull()){
                cm.sendSimple("#e#bDonation Rewards: #kYou have #r"+donaPoints+" #kDonation Points#n\r\n\r\n\r\n#L4##r1 Donation Point #bfor 10 #i2340000# White Scrolls#l\r\n\r\n#L5##r1 Donation Point #bfor 1 #i4031544# Green Wish Ticket#l\r\n\r\n#L6##r1 Donation Point #bfor 5 #i4002000# Snail Stamps#l\r\n\r\n#L7##r5 Donation Points #bfor 7 #i4031544# Green Wish Tickets#l\r\n\r\n#L8##r5 Donation Points #bfor 30 #i4002000# Snail Stamps#l\r\n\r\n#L9##r5 Donation Points #bfor 1 #i2040807# GM Scroll#l\r\n\r\n#L10##r10 Donation Points #bfor an extra 100 slots in buddy list#l\r\n\r\n#L11##r10 Donation Points #bfor GM Job with the skill Super Dragon Roar only#l\r\n\r\n#L12##r15 Donation Points #bfor 10 #i4002003# Slime Stamps#l\r\n\r\n#L13##r15 Donation Points #bfor a gender change to alien where you can wear both gender clothes at the same time, and for future rares#l\r\n\r\n#L14##r25 Donation Points #bfor Max out Stat Points(120,000 Stat Points)#l\r\n\r\n#L15##r40 Donation Points #bfor a #i1112807# SRB 3 ring#l\r\n\r\n#L16##r50 Donation Points #bfor a #i1082223# Stormcaster Glove with 50 Slots Clean#l\r\n\r\n#L17##r75 Donation Points #bfor 5 #i4002003# Slime Stamps, 10 #i4031544# Green Wish Tickets, #i1322013# Wizet Suitcase with 200 Weapon Attack#l\r\n\r\n#L18##r100 Donation Points #bfor 15 #i4002003# Slime Stamps, #i4031544# 30 Green Wish Tickets, #i1322013# #i1042003# #i1062007# Wizet Set.#l\r\n\r\n\r\n#L3##kGo Back\r\n#L2#Exit#l");
            } else {
