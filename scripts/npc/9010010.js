    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 13371) {
                ...
                cm.dispose();
            } else if (selection == 13373 && !cm.getPlayer().isGM()) {
                if (cm.getPlayer().getName().equalsIgnoreCase(cm.getDropEventHost()) || cm.getPlayer().isGM()) {
                    cm.worldMessage(6, cm.getPlayer().getName() + " has ended his/her's drop event.");
                    cm.endDropEvent();
                ...
                var string = "#eNow pick a rare as a prize#n:\r\n\r\n"
