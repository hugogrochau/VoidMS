...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		if (capacity >= 250 || cm.getMeso() < 240000){
			cm.sendNext("Hey... are you sure you have #b240,000 mesos#k? If so, then check and see if you have extended your buddy list to the max. Even if you pay up, the most you can have on your buddy list is #b250#k.");
			cm.dispose();
		} else {
