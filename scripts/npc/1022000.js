    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            if (cm.getJob().equals(client.MapleJob.BEGINNER)) {
                ...
                if (cm.getLevel() >= 30
                    && cm.getJob().equals(client.MapleJob.WARRIOR)) {
            ...
            if (cm.getJob().equals(client.MapleJob.BEGINNER))
                cm.changeJob(client.MapleJob.WARRIOR);
            ...
            if (selection == 0) {
                jobName = "Fighter";
                job = client.MapleJob.FIGHTER;
            } else if (selection == 1) {
                jobName = "Page";
                job = client.MapleJob.PAGE;
            } else {
                jobName = "Spearman";
                job = client.MapleJob.SPEARMAN;
            }
